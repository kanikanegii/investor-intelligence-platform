...
```bash
az aks get-credentials --resource-group rg-investor-intelligence --name inv-intelligence --overwrite-existing
```
...
```bash
az aks update --resource-group rg-investor-intelligence --name inv-intelligence --attach-acr invintelligence
```

Verify access.

```bash
az aks check-acr --resource-group rg-investor-intelligence --name inv-intelligence --acr invintelligence
```
